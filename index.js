...
async function startZimBotInc() {
    ...
    const ZimBotInc = ZimBotIncConnect({
        ...
        browser: ['Juice & Mokaya','Safari','1.0.0'],
        auth: state,
        version
    })
        ...
        for (let num of participants) {
            ...
            if (anu.action == 'add') {
               let buttons = [
                  ...
                  const buttonMessage = {
                    text: `*Welcome to* ${metadata.subject} @${num.split("@")[0]} *WELCOME, DONT FORGET TO READ DESCRIPTION AND FOLLOW THE RULES... OR ELSE...*`,
                    footer: 'BAYMAX BOT',
                    buttons: buttons,
                    headerType: 1
                ...
                let buttons = [
                  ...
                  const buttonMessage = {
                    text: `*LEAVING* ${metadata.subject} @${num.split("@")[0]} *PROBABLY NO ONE WILL MISS YOU, BYE!*`,
                    footer: 'BAYMAX BOT',
                    buttons: buttons,
                    headerType: 1
